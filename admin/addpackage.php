...
<?php include 'layouts/header.php';
 ...
 if(isset($_POST['savebtn']))
 {
 	...
 	if(insertPackage($conn,$_POST))
 	{
 		showMsg('Tour Package Created Successfully.','success');
			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="package_name" id="form-field-1" required placeholder="Name Of Package" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="location" id="form-field-1" required placeholder="Tour Location" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Duration:  </label>
							<div class="col-sm-9">
							<input type="text" name="duration" id="form-field-1" required placeholder="Duration in Days" class="col-xs-10 col-sm-5" />
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Price:</label>
							<div class="col-sm-9">
							<input type="text" name="price" id="form-field-1" required placeholder="Tour Rate in Rs." class="col-xs-10 col-sm-5" />
