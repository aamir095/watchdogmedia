			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="f_name" id="form-field-1" value="<?php echo $user['f_name']; ?>" required placeholder="First Name" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="l_name" id="form-field-1" value="<?php echo $user['l_name']; ?>" required placeholder="Last Name" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="email" name="email" id="form-field-1" value="<?php echo $user['email']; ?>" required placeholder="Email" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="address" id="form-field-1" value="<?php echo $user['address']; ?>" required placeholder="Address" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="contact" id="form-field-1" value="<?php echo $user['contact']; ?>" required placeholder="Contact" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select class="col-xs-10 col-sm-5" name="role">
