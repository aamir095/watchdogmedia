	<?php include 'layouts/header.php'; ?>
		...
		<li class="active">Manage ImageSlider</li>
		</ul><!-- .breadcrumb -->
	   ...
	   <?php $users = getAllImages($conn);
		...
		<td>
			<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
				...
				<a class="green" href="updateimage.php?ref=<?php echo $user['id']; ?>">
					<i class="icon-pencil bigger-130"></i>
				</a>

				<a class="red" href="deleteimage.php?ref=<?php echo $user['id']; ?>" onclick="return confirm('Are You Sure to Delete ?');">
