...
$userId = $_GET['ref'];
$user = getPackageById($conn,$userId);
 ...
 if(isset($_POST['savebtn']))
 {
 	...
 	{
 		$_POST['image_path']=uploadPackageImage('uploads',$_FILES['file']);
 		@unlink("uploads/".$user['image_path']);
 	
 	}

 	if(updatePackage($conn,$_POST))
 	{
...
?>
			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="package_name" id="form-field-1"  value="<?php  echo $user['package_name']; ?>"required placeholder="Name Of Package" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="location" id="form-field-1"   value="<?php  echo $user['location']; ?>" required placeholder="Tour Location" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Duration:  </label>
							<div class="col-sm-9">
							<input type="text" name="duration" id="form-field-1"  value="<?php  echo $user['duration']; ?>" required placeholder="Tour Duration" class="col-xs-10 col-sm-5" />
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Price:</label>
							<div class="col-sm-9">
							<input type="text" name="price" id="form-field-1"  value="<?php  echo $user['price']; ?>" required placeholder="Tour Price In Rs" class="col-xs-10 col-sm-5" />
		...
		</div><!-- /.mainwindow.jQuery || document.write("<script src='assets/js/jquery-1.10.2.min.js'>"+"<"+"/script>");
		</script>
		<![endif]-->
