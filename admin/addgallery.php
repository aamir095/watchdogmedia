...
<?php include 'layouts/header.php';
 ...
 {			
 			...
 			if(uploadgalleryimage('uploads',$_FILES['file'],$_POST,$conn))
 			{
...
?>
		...
		<ul class="breadcrumb">
			...
			<li class="active">Add To Gallery</li>
		</ul><!-- .breadcrumb -->
			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tour Gallery</label>

						<div class="col-sm-9">
							<input type="text" maxlength="70" name="project_name" id="form-field-1" required placeholder="Short Tour Description" class="col-xs-10 col-sm-5" />
						</div>
					</div>
				...
				<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Upload Multiple Images </label>

						<div class="col-sm-9">
							<input type="file" name="file[]" id="form-field-1"  multiple class="col-xs-10 col-sm-5" />
						</div>
					</div>
