...
$userId = $_GET['ref'];
$user = getProjectCategoryById($conn,$userId);


 if(isset($_POST['savebtn']))
 {
 	
 	if(updateProjectCategory($conn,$_POST))
 	{ 
 		showMsg('Project Category Updated Successfully.','success');
			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="project_category" id="form-field-1" value="<?php echo $user['project_category']; ?>" required placeholder="Name of  project category" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="category_description" id="form-field-1" value="<?php echo $user['category_description'] ?>" required placeholder="Concise description of project" class="col-xs-10 col-sm-5" />
						</div>
					</div>
