		...
		<tbody>
	   <?php $users = getAllGalleryImages($conn);
		...
		<td>
			<?php echo ucwords($user['project_name']); ?>
		</td>
		<?php if (!empty($user['image'])): ?>
		<td>
		<?php $images = explode(',',$user['image']);
		...
		<td>
			<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
					<a class="red" href="deleteimagegallery.php?ref=<?php echo $user['id']; ?>" onclick="return confirm('Are You Sure to Delete ?');">
