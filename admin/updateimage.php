			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Image Title </label>

						<div class="col-sm-9">
							<input type="text" name="image_title" id="form-field-1" value="<?php  echo $user["image_title"]; ?>" required placeholder="Image Short Title" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select class="col-xs-10 col-sm-5" name="position">
								<option value="1" <?php if($user['position']=='1') echo 'selected="selected"';  ?>>1</option>
								<option value="2" <?php if($user['position']=='2') echo 'selected="selected"';  ?>>2</option>
								<option value="3" <?php if($user['position']=='3') echo 'selected="selected"';  ?>>3</option>
								<option value="4" <?php if($user['position']=='4') echo 'selected="selected"';  ?>>4</option>
								<option value="5" <?php if($user['position']=='5') echo 'selected="selected"';  ?>>5</option>
								<option value="6" <?php if($user['position']=='6') echo 'selected="selected"';  ?>>6</option>
								<option value="7" <?php if($user['position']=='7') echo 'selected="selected"';  ?>>7</option>
