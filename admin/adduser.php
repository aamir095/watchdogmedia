			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="f_name" id="form-field-1" required placeholder="First Name" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="l_name" id="form-field-1" required placeholder="Last Name" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="email" name="email" id="form-field-1" required placeholder="Email" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="password" name="password" required id="form-field-2" placeholder="Password" class="col-xs-10 col-sm-5" />
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="address" id="form-field-1" required placeholder="Address" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="contact" id="form-field-1" required placeholder="Contact" class="col-xs-10 col-sm-5" />
						</div>
					</div>
